...
const EXTRA_EXERCISES = [
  ...
  { group:'Rug', group_en:'Back', icon:'🎿', color:'#553c9a', exercises:[
    ...
    { id:'ex-chu',  name:'Chin-up',              icon:'🤸', sets:3, reps:'6-10', rest:'90 sec', youtube:'https://www.youtube.com/watch?v=brhRXlOhsAM', photo:'images/oefeningen/chin-up.png'},
...
const EXTRA_EXERCISE_PHOTO_VERSION = 1;
